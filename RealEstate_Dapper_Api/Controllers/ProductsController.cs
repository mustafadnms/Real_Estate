...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        {
            var values = await _productRepository.GellAllProductWithCategoryAsync();
            return Ok(values);
        }

        [HttpGet("ProductDealOfTheDayStatusChangeToTrue/{id}")]
        public async Task<IActionResult> ProductDealOfTheDayStatusChangeToTrue(int
            id)
        {
		...
		public async Task<IActionResult> ProductDealOfTheDayStatusChangeToFalse(int
			id)
		{
        ...
        {
            await _productRepository.CreatePrduct(createProductDto);
